...
export default class ExpenseForm extends React.Component {
	...
	onSubmit = e => {
		...
		if (!this.state.description || !this.state.amount) {
			this.setState(() => ({ error: 'Please fill in the description and amount fields!' }))
		} else {
	...
	render() {
		return (
			<form className='form' onSubmit={this.onSubmit}>
				...
				<textarea className="text-area" placeholder="Add a not for your expense (optional)" value={this.state.note} onChange={this.onNoteChange}></textarea>
				<div>
